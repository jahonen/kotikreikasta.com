...
export async function optimizeImage(
  ...
  try {
    ...
    functions.logger.info('Optimizing image', {
    ...
    functions.logger.info('Input image metadata', {
    ...
    functions.logger.error('Image optimization failed', {
      error: error?.message,
...
export async function fetchAndOptimizeImage(
  ...
  try {
    functions.logger.info('Fetching image for optimization', { imageUrl });
    ...
    functions.logger.error('Failed to fetch and optimize image', {
      imageUrl,
      error: error?.message,
    });
    throw error;
